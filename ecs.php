...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $services->set(PhpCsFixer\Fixer\Casing\ConstantCaseFixer::class)->call('configure', [['case' => 'lower']]);
    ...
    $services->set(PhpCsFixer\Fixer\ClassNotation\OrderedClassElementsFixer::class)->call('configure', [['sort_algorithm' => 'alpha']]);
    $services->set(PhpCsFixer\Fixer\ClassNotation\OrderedInterfacesFixer::class)->call('configure', [['order' => 'alpha']]);
    ...
    $services->set(PhpCsFixer\Fixer\Import\NoUnusedImportsFixer::class);
    $services->set(PhpCsFixer\Fixer\Import\OrderedImportsFixer::class)->call('configure', [['imports_order' => ['class', 'const', 'function']]]);
    ...
    $services->set(PhpCsFixer\Fixer\PhpUnit\PhpUnitTestCaseStaticMethodCallsFixer::class)->call('configure', [['call_type' => 'self']]);
